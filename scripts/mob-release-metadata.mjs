const MOB_VERSION_GROUPS = [
  { version: "Classic", ids: ["creeper", "pig", "skeleton", "zombie", "spider", "sheep"] },
  { version: "Indev", ids: ["giant"] },
  { version: "Alpha", ids: ["cow", "slime", "chicken", "ghast"] },
  { version: "Beta", ids: ["squid", "wolf", "cave_spider", "enderman", "silverfish"] },
  { version: "1.0", ids: ["blaze", "magma_cube", "mooshroom", "snow_golem", "villager", "ender_dragon"] },
  { version: "1.2.1", ids: ["ocelot", "iron_golem"] },
  { version: "1.4.2", ids: ["zombie_villager", "wither", "wither_skeleton", "bat", "witch"] },
  ...
  { version: "1.14", ids: ["panda", "pillager", "ravager", "cat", "trader_llama", "wandering_trader", "fox"] },
